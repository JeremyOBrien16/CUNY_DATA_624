...
```{r}
train<-rename(tbl.perf.train2, Train_Method=Method)
test<-rename(tbl.perf.test2, Test_Method=Method)

kable(list(train, test), caption="Test2 Performance", booktabs=T, digits=4)%>%
  kable_styling() 
```
