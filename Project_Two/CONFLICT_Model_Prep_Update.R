...
saveRDS(train, file = "_train.rsd")
saveRDS(test, file = "_test.rsd")
saveRDS(eval, file = "_eval.rsd")
saveRDS(train_trans, file = "_train_trans.rsd")
saveRDS(test_trans, file = "_test_trans.rsd")
saveRDS(eval_trans, file = "_eval_trans.rsd")
...
## Save Models
saveRDS(fit_mars1, "_fit_mars1.rsd")
saveRDS(fit_mars2, "_fit_mars2.rsd")
saveRDS(fit_rf1, "_fit_rf1.rsd")
saveRDS(fit_rf2, "_fit_rf2.rsd")
saveRDS(fit_cub1, "_fit_cub1.rsd")
saveRDS(fit_cub2, "_fit_cub2.rsd")
saveRDS(fit_svm1, "_fit_svm1.rsd")
saveRDS(fit_svm2, "_fit_svm2.rsd")