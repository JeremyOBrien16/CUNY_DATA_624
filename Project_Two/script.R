...
test <- readRDS(file = "test.rsd")
eval<- readRDS(file = "eval.rsd")
train_trans <- readRDS(file = "train_trans.rsd")
test_trans <- readRDS(file = "test_trans.rsd")
eval_trans <- readRDS(file = "eval_trans.rsd")
fit_mars1 <- readRDS("fit_mars1.rsd")
fit_mars2 <- readRDS("fit_mars2.rsd")
fit_rf1 <- readRDS("fit_rf1.rsd")
fit_rf2 <- readRDS("fit_rf2.rsd")
fit_cub1 <- readRDS("fit_cub1.rsd")
fit_cub2 <- readRDS("fit_cub2.rsd")
fit_svm1 <- readRDS("fit_svm1.rsd")
fit_svm2 <- readRDS("fit_svm2.rsd")
